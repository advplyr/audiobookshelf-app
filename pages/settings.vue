<template>
  <div class="w-full h-full px-4 py-8 overflow-y-auto">
    ...
    <div class="flex items-center py-3">
      <div class="w-10 flex justify-center" @click="toggleUseDurationInChaptersModal">
        <ui-toggle-switch v-model="settings.useDurationInChaptersModal" @input="saveSettings" />
      </div>
      <p class="pl-4">{{ $strings.LabelUseDurationInChaptersModal }}</p>
    </div>
...
export default {
  data() {
    return {
      ...
      settings: {
        ...
        useDurationInChaptersModal: true,
        jumpForwardTime: 10,
  ...
  methods: {
    ...
    toggleUseDurationInChaptersModal() {
      this.settings.useDurationInChaptersModal = !this.settings.useDurationInChaptersModal
      this.saveSettings()
    },
    ...
    setDeviceSettings() {
      ...
      this.settings.useDurationInChaptersModal = !!deviceSettings.useDurationInChaptersModal
