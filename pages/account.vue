<template>
  <div class="w-full h-full p-4">
    ...
    <div class="flex items-center pt-8">
      <div class="flex-grow" />
      <p class="pr-2 text-sm font-book text-yellow-400">Report bugs, request features, provide feedback, and contribute on <a class="underline" href="https://github.com/Oasis256/bookShelf-app" target="_blank">github</a>.</p>
      <a href="https://github.com/Oasis256/bookShelf-app" target="_blank" class="text-white hover:text-gray-200 hover:scale-150 hover:rotate-6 transform duration-500">
