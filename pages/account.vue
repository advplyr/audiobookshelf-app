<template>
  <div class="w-full h-full p-4" :style="contentPaddingStyle">
    ...
    <div v-if="serverVersion" class="text-sm text-on-surface">
    ...
    <div class="flex justify-center items-center my-4 left-0 right-0 absolute" :style="bottomContentStyle">
      <p class="text-sm text-on-surface">{{ $strings.MessageReportBugsAndContribute }} <a class="underline" href="https://github.com/AwsomeFox/tomesonic-app" target="_blank">GitHub</a></p>
      <a href="https://github.com/AwsomeFox/tomesonic-app" target="_blank" class="text-on-surface hover:scale-150 hover:rotate-6 transform duration-500 ml-2">
