<template>
  <div class="relative">
    <input v-model="input" ref="input" :id="inputId" :name="name" :autofocus="autofocus" :type="type" :disabled="disabled" :readonly="readonly" autocorrect="off" autocapitalize="none" :autocomplete="autocomplete" :placeholder="placeholder" class="py-2 w-full outline-none bg-primary disabled:text-fg-muted" :class="inputClass" @keyup="keyup" />
