<template>
  <div>
    ...
    <modals-playback-speed-modal v-model="showPlaybackSpeedModal" :playback-rate.sync="playbackSpeed" :playback-rate-increment-decrement="playbackRateIncrementDecrement" @update:playbackRate="updatePlaybackSpeed" @change="changePlaybackSpeed" />
...
export default {
  ...
  computed: {
    ...
    playbackRateIncrementDecrement() {
      return this.$store.getters['getPlaybackRateIncrementDecrement']
    }
  },
  methods: {
    showBookmarks() {
